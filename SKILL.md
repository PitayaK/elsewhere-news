...
每次逛完 Elsewhere、把推荐呈现给人类之后，更新你的长期记忆。记住以下四类信息：
...
记下你对每个创作者的印象。特别关注：
- 人类**实际点开看了**的文章是谁写的 → 这个创作者的内容跟人类匹配度高
- 人类**没有点开**的推荐是谁写的 → 下次降低优先级
- 如果人类主动提到了某个创作者（"这个人写得好"/"这个人的东西太浅了"）→ 直接记录人类的原话

格式建议：
```
[Elsewhere 创作者印象]
- elselier: 人类连续两次都看了，特别喜欢创业者速写的风格
- XX播客: 推荐过一次，人类没打开，可能不喜欢音频形式
- 张三: 人类说过"这个人的观点很有意思"
```

#### 5c: 人类反馈

人类对你推荐的内容可能有反馈，也可能没有。如果有，一定要记住：

- **正面反馈**（"这篇不错"、"谢谢推荐"、主动问了更多）→ 记住是什么话题/角度/创作者引起了兴趣
- **负面反馈**（"这个我不感兴趣"、"太长了"、"这个我知道了"）→ 记住人类不想看什么类型的内容
- **没有反馈** → 不要过度解读，但连续多次没有反馈可以适当减少推荐频率

格式建议：
```
[Elsewhere 人类反馈]
- 2026-03-22: 推荐了3篇，人类看了gao-daiheng那篇，说"他见投资人的经验很实用"
- 2026-03-20: 推荐了2篇，人类都没看
```

#### 5d: 兴趣变化

结合你日常跟人类的交流，留意人类兴趣的变化。这不只是 Elsewhere 相关的 — 人类在任何场景下表达的兴趣都应该影响你下次逛 Elsewhere 时的判断。

例如：
- 人类最近开始聊出海 → 下次 Step 2 写理由时，出海相关的文章理由会更强
- 人类最近对 VC 的话题不怎么回应 → 下次降低 VC 类内容的优先级
- 人类换了工作方向 → 大幅调整偏好

**不需要单独为 Elsewhere 维护一份兴趣档案** — 用你已有的对人类的了解就行。只是每次逛 Elsewhere 前，有意识地回顾一下人类最近的状态。
...
| 步骤 | 用到的记忆 |
|------|-----------|
| Step 1 时效性筛选 | `judge_relevance` 的判断基于你对人类兴趣的了解（5d） |
| Step 2 写理由 | 创作者印象（5b）让你对某些创作者的内容天然有更强/更弱的理由 |
| Step 2 排名 | 人类反馈（5c）帮你知道什么角度人类会买账 |
| Step 3 质量确认 | 人类反馈（5c）帮你校准"值不值得人类花时间"的判断 |
